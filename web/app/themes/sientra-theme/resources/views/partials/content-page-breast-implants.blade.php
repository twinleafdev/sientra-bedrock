...
<!--     <img src="@asset('images/implant-options-surg.svg')" class="img-fluid" alt="achieve your desired look" /> -->
    <h3 class="image-h mx-auto" style="background-image:url(@asset('images/implant-options-surg.svg'));  height: 16vw; ">achieve your desired look</h3>
  </header>
	<div class="h2-wrap">
	...
	<div class="gel-diagram container">
      <img src="@asset('images/gel-diagram-mobile.jpg')" class="img-fluid my-5 d-md-none" alt="gel-diagram-mobile" width="1000" height="1333" />
			<img src="@asset('images/gel-diagram.svg')" class="img-fluid my-5 d-none d-md-block" alt="gel-diagram" />
	</div><!-- .container -->
</section>
