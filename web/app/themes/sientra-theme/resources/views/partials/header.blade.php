<header class="banner" id="top">
  <a href="http://locator.sientra.com/feelgood/"><img src="@asset('images/locator-tan.svg')" class="locator" alt="locator-form" /></s>
  <div class="container-fluid">
    <div class="row ">
      ...
      <nav class="col-6 col-lg-12  ml-auto mx-lg-auto my-3 mt-lg-2 mb-lg-1 nav-primary navbar navbar-expand-lg">
